...
import styles from './ChargeCardList.module.css';
...
export default function ChargeCardList({
  hostName,
  avatarUrl,
  price,
  level,
      ...
      <div className={styles.mainContent}>
        <div className={styles.header}>
          <div>
            ...
            <p className={styles.rating}>★ 4.9 (42 reviews) · {distance}</p>
          </div>
        ...
        {/* Badges - top right of main content */}
